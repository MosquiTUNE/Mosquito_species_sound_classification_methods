...
class ResNetLayer(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, block=ResNetBasicBlock, n=1, b_selfattention=True, *args, **kwargs):
        super().__init__()

        self.b_selfattention=b_selfattention
...
class ResNetEncoder(nn.Module):
    ...
    def __init__(self, in_channels=3, blocks_sizes=[64, 128, 256, 512], deepths=[2, 2, 2, 2],
                 activation=nn.ReLU, block=ResNetBasicBlock, b_selfattention=True, *args, **kwargs):
        super().__init__()
        ...
        self.blocks = nn.ModuleList([
            ResNetLayer(blocks_sizes[0], blocks_sizes[0], n=deepths[0], activation=activation,
                        block=block, b_selfattention=b_selfattention, *args, **kwargs),
...
class ResAtt(nn.Module):
    ...
    def __init__(self, in_channels, n_classes, b_selfattention=True, *args, **kwargs):
        super().__init__()
        self.encoder = ResNetEncoder(in_channels, b_selfattention=b_selfattention, *args, **kwargs)
...
def resnet18_attention(in_channels, n_classes, b_selfattention=True):
    return ResAtt(in_channels, n_classes, block=ResNetBasicBlock, deepths=[2, 2, 2, 2], b_selfattention=b_selfattention)
